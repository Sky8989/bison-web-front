<template>
  <div class="Image-top-product-warp">
        ...
        <el-col :span="20">
          <el-col :span="3" name="imgType">
            <el-button
              ...
              @click="chooseImgType('imgType-1')"
            >橱窗图</el-button>
            <el-button
              id="imgType-2"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-2')"
            >EBC</el-button>
            <el-button
              id="imgType-3"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-3')"
            >品牌推广图</el-button>
            <el-button
              id="imgType-4"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-4')"
            >实物图</el-button>
            <el-button
              id="imgType-5"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-5')"
            >包装图片</el-button>
            <el-button
              id="imgType-6"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-6')"
            >说明书图片</el-button>
            <el-button
              id="imgType-7"
              style="display: block;margin-left: 0px;width: 130px"
              @click="chooseImgType('imgType-7')"
            >其他</el-button>
          </el-col>

          <el-col :span="16" name="imgList">
            <div class="el-upload__tip">
              <b>请先选择要上传的图片,再确认上传,上传图片!</b>
            </div>
            <!--  multiple :limit="5"-->
            <el-upload
              class="upload-demo"
    ...
    <el-dialog title="需要删除以下图片" :visible.sync="deleteDialog" width="80%">
      <el-upload
        name="file"
        multiple
        :limit="10"
