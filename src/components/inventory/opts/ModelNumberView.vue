  ...
  <div name="ModelNumberView">
    ...
    <el-table name="showTable" border="border" height="350px" style="width: 100%" :data="InventoryList"
      ...
      <el-table-column label="供应商">
        ...
        <el-table-column prop="supplierInventoryVO.supplierInventoryTotalQuantity" label="供应商总库存"></el-table-column>
      </el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      checkBu() {
        //var url = this.URL_ROOT + this.PREFIX_SALES_PLAN  + "/businessUnitHandler/findByUserId/" + this.userId
      ...
      search() {
        var url =this.URL_ROOT + this.PREFIX_INVENTORY + "/inventoryByModelNumberHandler/findModelNumberInventoryList"
      ...
      saveALlProductInventory() {
        ...
        var url =this.URL_ROOT + this.PREFIX_INVENTORY + "/inventoryByModelNumberHandler/saveAllProductInventoryInfo"
        this.$ajax({
          method: 'post',
          url: url,
          data: this.formInfo
