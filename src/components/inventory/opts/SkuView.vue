    ...
    <el-form :model="searchInfo"  method="post"   encType="multipart/form-data">
      <el-form-item style="float: left">
        <el-row :gutter="10">
          ...
          <el-col :span="4">
            <el-select placeholder="产品型号"  filterable clearable  v-model="searchInfo.productId" @change="chooseProduct" size="mini">
          ...
          <el-col :span="4">
            <el-select placeholder="产品型号"  filterable clearable  v-model="searchInfo.sellerSkuId"  size="mini">
              <el-option v-for="sellerSku in sellerSkuList" :key="sellerSku.sellerSkuId" :value="sellerSku.sellerSkuId" :label="sellerSku.sku"></el-option>
            </el-select>
          </el-col>
...
<script>
    export default {
      ...
      methods:{
        ...
        initSellSkuList(){
          var url = this.HOST + "/inventoryBySKUHandler/findSellSkuList"
          this.$ajax.get( url,{
          }).then(res => {
            if(res.data.code == "200"){
              var data = res.data.data
        ...
        chooseProduct(){
          ...
          if(  productId != null && productId != 0 && productId != ''){
            ...
            var url = this.HOST  + "/inventoryBySKUHandler/findSellerSkuListByProductId/" + productId
            console.log(url)
